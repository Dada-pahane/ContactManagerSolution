...
namespace CRUDTests
{
    public class PersonsControllerTest
    {
        ...
        private readonly IPersonsSortederService _PersonsSortederService;
        private readonly IPersonsExcelWith3Column _personsExcelWith3Column;
        ...
        private readonly Mock<IPersonsSortederService> _PersonsSortederServiceMock;
        private readonly Mock<IPersonsExcelWith3Column> _personsExcelWith3ColumnMock;
        ...
        public PersonsControllerTest()
        {
            ...
            _PersonsSortederServiceMock = new Mock<IPersonsSortederService>();
            _personsExcelWith3ColumnMock=new Mock<IPersonsExcelWith3Column>();
            ...
            _PersonsSortederService = _PersonsSortederServiceMock.Object;
            _personsExcelWith3Column = _personsExcelWith3ColumnMock.Object;
        ...
        public async Task Index_ShouldReturnIndexViewWithPersonsList()
        {
            ...
            PersonsController personsController = new PersonsController(
                ...
                _personsDeleteService, _PersonsSortederService,
                _personsUpdateService, _countriesService,_logger, _personsExcelWith3Column);
        ...
        public async void Create_IfNoModelErrors_ToReturnRedirectToIndex()
        {
            ...
            PersonsController personsController = new PersonsController(_PersonsGetterService,_personsAdderService
                ,_personsDeleteService,_PersonsSortederService,_personsUpdateService, _countriesService, _logger,_personsExcelWith3Column);
