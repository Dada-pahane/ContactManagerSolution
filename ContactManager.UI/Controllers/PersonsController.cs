...
namespace CRUDExample.Controllers
{
    ...
    public class PersonsController : Controller
    {
        ...
        public PersonsController(IPersonsGetterService personsGetterService,
            ...
            IPersonsSortederService personsSortederService,
            IPersonsUpdateService personsUpdateService,
            ICountriesService countriesService,
            ILogger<PersonsController> logger,
             IPersonsExcelWith3Column personsExcelWith3Column)
        {
            this._personsGetterService = personsGetterService;
            this._personsAdderService = personsAdderService;
            this._personsDeleteService = personsDeleteService;
            this._personsSortederService = personsSortederService;
            this._personsUpdateService = personsUpdateService;
            this._countriesService = countriesService;
            this._logger = logger;
            _personsExcelWith3Column = personsExcelWith3Column;
        }
        ...
        public async Task<IActionResult> Index(string searchBy, string? searchString, string sortBy = nameof(PersonResponse.PersonName), SortOrderOptions sortOrder = SortOrderOptions.ASC)
        {
            ...
            //Sort
            List<PersonResponse> sortedPersons = await _personsSortederService.GetSortedPersons(persons, sortBy, sortOrder);
        ...
        {
            MemoryStream memoryStream = await _personsExcelWith3Column.GetPersonsExcel();
