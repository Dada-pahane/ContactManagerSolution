...
namespace CRUDTests
{
    public class PersonsServiceTest
    {
        ...
        public PersonsServiceTest(ITestOutputHelper testOutputHelper)
        {
            ...
            _personsDeleteService = new PersonsDeleteService(_personsRepository, loggerMock.Object, diagnosticContextMock.Object);
            _personsUpdateService = new PersonsUpdateService(_personsRepository, loggerMock.Object, diagnosticContextMock.Object);
            _personsSortederService = new PersonsSortederService(_personsRepository, loggerMock.Object, diagnosticContextMock.Object);
    ...
    .Create()
            ...
            //Act
            List<PersonResponse> persons_list_from_sort = await _personsSortederService.GetSortedPersons(allPersons, nameof(Person.PersonName), SortOrderOptions.DESC);
